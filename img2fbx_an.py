...
# Command 1
command1 = [
    "python", "demos/exp_trans_multi.py",
    "--image_path", "input",
    "--saveObj", "True",
    "--useTex", "True"
]
...
if proc2.returncode != 0:
    print("Error executing .obj to .fbx shell script!")
...
print("\nExecuting script to run merge hair and body...")
